...
import torchvision.keras as kt
...
def build_cnn(filters, kernels, input_shape, dr=0):
    ...
    pretrained = keras.applications.ResNet50(include_top=False, weights='imagenet', input_shape=input_shape)
    model = keras.applications.ResNet50(include_top=False, weights='imagenet', input_shape=input_shape)
    return model
