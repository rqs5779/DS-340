...
def build_cnn(filters, kernels, input_shape, dr=0):
    ...
    # Dense Neural Networks model that pretrained with tensorflow
...
def main(datadir, vars, filters, kernels, lr, activation, dr, batch_size, patience, model_save_fn, pred_save_fn,
    ...
    model.fit(dg_train, epochs=300, validation_data=dg_valid,
...
if __name__ == '__main__':
    ...
    p.add_argument('--train_years', type=str, nargs='+', default=('2015', '2016'), help='Start/stop years for training')
    p.add_argument('--valid_years', type=str, nargs='+', default=('2017', '2017'), help='Start/stop years for validation')
    p.add_argument('--test_years', type=str, nargs='+', default=('2018', '2018'), help='Start/stop years for testing')
